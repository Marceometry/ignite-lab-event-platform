      ...
      <div className='p-8 max-w-[1100px] mx-auto'>
        <div className='flex items-start gap-16'>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <a
              href=''
              className='p-4 text-sm text-blue-500 border border-blue-500 flex items-center justify-center gap-2 rounded font-bold uppercase hover:bg-blue-500 hover:text-gray-900 transition-colors'
            >
              <Lightning size={24} />
              Acesse o desafio
            </a>
